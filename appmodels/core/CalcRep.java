...
public class CalcRep extends AppModelBase {		private Window Window;

	public CalcRep() throws GeneralLeanFtException 
	{
		setName("CalcRep");
		...
		public class Window extends WindowNodeBase
	{
			...
			private ApplicationFrameTitleBarWindowUiObject ApplicationFrameTitleBarWindowUiObject;
	private UiObject UiObject;
	private ApplicationFrameInputSinkWindowUiObject ApplicationFrameInputSinkWindowUiObject;
						public Window(AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(applicationModel);

					ApplicationFrameTitleBarWindowUiObject = new ApplicationFrameTitleBarWindowUiObject(this, applicationModel);
		UiObject = new UiObject(this, applicationModel);
		ApplicationFrameInputSinkWindowUiObject = new ApplicationFrameInputSinkWindowUiObject(this, applicationModel);
			
			setDisplayName("Калькулятор");
		}
		...
		protected com.hp.lft.sdk.stdwin.WindowDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.stdwin.WindowDescription.Builder().childWindow(false).ownedWindow(false).windowClassRegExp("ApplicationFrameWindow").windowTitleRegExp("Калькулятор").build();
			}catch(Exception e){
			...
			return description;
				...
				public ApplicationFrameTitleBarWindowUiObject ApplicationFrameTitleBarWindowUiObject() { return ApplicationFrameTitleBarWindowUiObject; }
		public UiObject UiObject() { return UiObject; }
		public ApplicationFrameInputSinkWindowUiObject ApplicationFrameInputSinkWindowUiObject() { return ApplicationFrameInputSinkWindowUiObject; }
		
			public class ApplicationFrameTitleBarWindowUiObject extends UiObjectNodeBase
	{

		
								public ApplicationFrameTitleBarWindowUiObject(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("ApplicationFrameTitleBarWindow");
		}
		...
		protected com.hp.lft.sdk.stdwin.UiObjectDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.stdwin.UiObjectDescription.Builder().windowClassRegExp("ApplicationFrameTitleBarWindow").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class UiObject extends UiObjectNodeBase
	{

		
								public UiObject(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.stdwin.UiObjectDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.stdwin.UiObjectDescription description = null; 
			try{
				description = new com.hp.lft.sdk.stdwin.UiObjectDescription.Builder().windowClassRegExp("Windows.UI.Core.CoreWindow").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class ApplicationFrameInputSinkWindowUiObject extends UiObjectNodeBase
	{

		
								public ApplicationFrameInputSinkWindowUiObject(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("ApplicationFrameInputSinkWindow");
		}
		...
		protected com.hp.lft.sdk.stdwin.UiObjectDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.stdwin.UiObjectDescription description = null; 
			try{
				description = new com.hp.lft.sdk.stdwin.UiObjectDescription.Builder().windowClassRegExp("ApplicationFrameInputSinkWindow").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
